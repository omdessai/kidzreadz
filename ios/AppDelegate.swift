...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  // The appID, accessToken and appEndpoint are required values for MobilePush SDK configuration.
    ...
    let appID = "e7226164-6340-4660-9964-97641dcc9578"
    let accessToken = "cbGTACDuFgOzNTGGSHAXfBOo"
    let appEndpoint = "https://mc3g-whh0zyq0nkwpmgbnlj3m46m.device.marketingcloudapis.com/"
    let mid = "10973840"
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ...
    let rootView = RCTRootView(bundleURL: jsCodeLocation, moduleName: "KidzReadz", initialProperties: nil, launchOptions: launchOptions)
